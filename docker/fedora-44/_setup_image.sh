...
dnf update -y
dnf install -y `cat /tmp/_setup_package_list_44.txt`
...
fusionfree=$fusion/free/fedora/rpmfusion-free-release-44.noarch.rpm
fusionnonfree=$fusion/nonfree/fedora/rpmfusion-nonfree-release-44.noarch.rpm
