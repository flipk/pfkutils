...
\(Type \\[describe-mode] in the shell buffer for a list of commands.)"
  ...
  (let* ((prog (or explicit-shell-file-name
    ...
    (set-buffer (apply 'make-comint
			 ...
			 '("-i"))))
    (shell-mode)
    (switch-to-buffer (concat "*shell" shell-number "*"))))
...
;;; All the commands that munge the buffer's dirstack finish by calling
;;; this guy.
