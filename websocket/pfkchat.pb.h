...
// source: pfkchat.proto

#ifndef PROTOBUF_pfkchat_2eproto__INCLUDED
#define PROTOBUF_pfkchat_2eproto__INCLUDED
...
void  protobuf_AddDesc_pfkchat_2eproto();
void protobuf_AssignDesc_pfkchat_2eproto();
void protobuf_ShutdownFile_pfkchat_2eproto();
...
enum ClientToServerType {
  CTS_LOGIN = 1,
  CTS_CHANGE_USERNAME = 2,
  CTS_IM_MESSAGE = 3,
  CTS_PING = 4
};
bool ClientToServerType_IsValid(int value);
const ClientToServerType ClientToServerType_MIN = CTS_LOGIN;
const ClientToServerType ClientToServerType_MAX = CTS_PING;
const int ClientToServerType_ARRAYSIZE = ClientToServerType_MAX + 1;

const ::google::protobuf::EnumDescriptor* ClientToServerType_descriptor();
inline const ::std::string& ClientToServerType_Name(ClientToServerType value) {
  return ::google::protobuf::internal::NameOfEnum(
    ClientToServerType_descriptor(), value);
}
inline bool ClientToServerType_Parse(
    const ::std::string& name, ClientToServerType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ClientToServerType>(
    ClientToServerType_descriptor(), name, value);
}
enum ServerToClientType {
  STC_USER_LIST = 1,
  STC_USER_STATUS = 2,
  STC_LOGIN_NOTIFICATION = 3,
  STC_LOGOUT_NOTIFICATION = 4,
  STC_CHANGE_USERNAME = 5,
  STC_IM_MESSAGE = 6,
  STC_PONG = 7
};
bool ServerToClientType_IsValid(int value);
const ServerToClientType ServerToClientType_MIN = STC_USER_LIST;
const ServerToClientType ServerToClientType_MAX = STC_PONG;
const int ServerToClientType_ARRAYSIZE = ServerToClientType_MAX + 1;

const ::google::protobuf::EnumDescriptor* ServerToClientType_descriptor();
inline const ::std::string& ServerToClientType_Name(ServerToClientType value) {
  return ::google::protobuf::internal::NameOfEnum(
    ServerToClientType_descriptor(), value);
}
inline bool ServerToClientType_Parse(
    const ::std::string& name, ServerToClientType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ServerToClientType>(
    ServerToClientType_descriptor(), name, value);
}
// ===================================================================
...
class Username : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_pfkchat_2eproto();
  friend void protobuf_AssignDesc_pfkchat_2eproto();
  friend void protobuf_ShutdownFile_pfkchat_2eproto();
...
class ClientToServer : public ::google::protobuf::Message {
 public:
  ...
  // required .PFK.Chat.ClientToServerType type = 1;
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 1;
  inline ::PFK::Chat::ClientToServerType type() const;
  inline void set_type(::PFK::Chat::ClientToServerType value);
...
class ServerToClient : public ::google::protobuf::Message {
 public:
  ...
  // required .PFK.Chat.ServerToClientType type = 1;
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 1;
  inline ::PFK::Chat::ServerToClientType type() const;
  inline void set_type(::PFK::Chat::ServerToClientType value);
...
inline ::PFK::Chat::ClientToServerType ClientToServer::type() const {
  return static_cast< ::PFK::Chat::ClientToServerType >(type_);
}
inline void ClientToServer::set_type(::PFK::Chat::ClientToServerType value) {
  assert(::PFK::Chat::ClientToServerType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline ::PFK::Chat::ServerToClientType ServerToClient::type() const {
  return static_cast< ::PFK::Chat::ServerToClientType >(type_);
}
inline void ServerToClient::set_type(::PFK::Chat::ServerToClientType value) {
  assert(::PFK::Chat::ServerToClientType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::PFK::Chat::ClientToServerType>() {
  return ::PFK::Chat::ClientToServerType_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::PFK::Chat::ServerToClientType>() {
  return ::PFK::Chat::ServerToClientType_descriptor();
}
...
#endif  // PROTOBUF_pfkchat_2eproto__INCLUDED
